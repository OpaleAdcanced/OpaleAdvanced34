...
scImgMgr.xInitAnim = function(pAnim,pOpts,pId) {
	try {
		if (this.xIsVisible(pAnim)){
			...
			var vMaxHeight = 0;
			var vMaxWidth = 0;
			for(var k=0; k<pAnim.fImgs.length; k++) {
...
scImgMgr.sZmMagMove = function(pEvt) {
	...
	var vMag = vEvt.target;
	var vAnc = vMag.fAnc
	var vX = vMag.offsetLeft + (typeof vEvt.layerX != "undefined" ? vEvt.layerX : vEvt.offsetX);
	var vY = vMag.offsetTop + (typeof vEvt.layerY != "undefined" ? vEvt.layerY : vEvt.offsetY);
	try {
		if (!vMag.fMax) {
