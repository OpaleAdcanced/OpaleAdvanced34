 ...
 * Given a displayed image (reduced) and a large scale version (must have the 
 * same ratio), imgZoomMgr will display a rectangular "magnifying glass" 
 * when the mouse is over the reduced image. The user can click ont the 
